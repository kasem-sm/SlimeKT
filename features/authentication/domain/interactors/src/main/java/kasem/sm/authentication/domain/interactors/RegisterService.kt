...
import kasem.sm.authentication.domain.model.containsWhiteSpaces
...
class RegisterService @Inject constructor(
    ...
    private fun validateCredentials(
        ...
        return when {
            ...
            username.trim().containsWhiteSpaces -> "Spaces are not allowed inside username".toInvalidCredentialsException()
            password.trim().containsWhiteSpaces -> "Spaces are not allowed inside password".toInvalidCredentialsException()
